...
class BarIcon:
    ...
    def tick(self, dt):
        ...
        x_offset = (self.play_state.health / 2) * (self.health_bar.image_rect.w - 8) - (self.health_bar.image_rect.w / 2)
...
class HealthBar:
    ...
    def tick(self, dt):
        self.upper_bar.w = (self.image_rect.w - 8) * (self.play_state.health / 2)
